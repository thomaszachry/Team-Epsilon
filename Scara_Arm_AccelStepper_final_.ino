...
// Pull+ pin = 0
// Dir+ pin = 1
const int BASE_STEPPER_STEP_PIN = 23;
const int BASE_STEPPER_DIR_PIN = 22;
//const int STEPPER_1_ENABLE_PIN = 21;
//Stepper _2 = armMtr
//Pull+ pin = 2
//Dir+ pin = 3
const int ARM_STEPPER_STEP_PIN = 21;
const int ARM_STEPPER_DIR_PIN = 20;
//const int STEPPER_2_ENABLE_PIN = 18;

const int LINEAR_ACTUATOR_FEEDBACK = 19;
const int LINEAR_ACTUATOR_PWM = 18;
const int LINEAR_ACTUATOR_Activate = 17;

const int AIR_SOLENOID = 16;

const int AIR_PUMP_PWM = 0;
const int AIR_PUMP_INA = 1
const int AIR_PUMP_INB = 2;

const int ARM_LIMIT_SWITCH_LEFT = 6;
const int ARM_LIMIT_SWITCH_RIGHT = 7;

const int BASE_LIMIT_SWITCH = 8;

const int ARM_ENCODER_INA = 9;
const int ARM_ENCODER_INB=10;
const int BASE_ENCODER_INA = 11;
const int BASE_ENCODER_INB = 12;


//Unneeded declerations
...
//Base_Mtr
AccelStepper Base_Stepper(1, BASE_STEPPER_STEP_PIN, BASE_STEPPER_DIR_PIN);
//Arm_Mtr
AccelStepper Arm_Stepper(1, ARM_STEPPER_STEP_PIN, ARM_STEPPER_DIR_PIN);
//Unneeded
